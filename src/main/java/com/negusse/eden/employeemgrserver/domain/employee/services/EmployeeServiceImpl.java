package com.negusse.eden.employeemgrserver.domain.employee.services;

import com.negusse.eden.employeemgrserver.domain.core.exceptions.ResourceCreationException;
import com.negusse.eden.employeemgrserver.domain.core.exceptions.ResourceNotFoundException;
import com.negusse.eden.employeemgrserver.domain.employee.models.Employee;
import com.negusse.eden.employeemgrserver.domain.employee.repos.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public Employee create(Employee employee) throws ResourceCreationException {
        ...
        if(optional.isPresent())
            throw new ResourceCreationException("Employee with that email exists:" + employee.getEmail());
